...
urlpatterns = [
    ...
    path('team-management', views.team_management, name='team-management'),
    ...
    path('api/dt/users', views.dt_users, name='users_dt'),
    path('api/dt/teams', views.dt_teams, name='teams_dt'),
    ...
    path('api/delete-team/<int:id>', views.delete_team, name='delete-team'),
